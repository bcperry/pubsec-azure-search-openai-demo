    ...
    assert uploaded_to_search == [
        {
            ...
            "sourcepage": "a.txt",
            "sourcefile": "a.txt",
            "storageUrl": f"https://test.blob.{cloudConfig['storageEndpointSuffix']}/a.txt",
        },
        {
            ...
            "sourcepage": "b.txt",
            "sourcefile": "b.txt",
            "storageUrl": f"https://test.blob.{cloudConfig['storageEndpointSuffix']}/b.txt",
        },
        {
            ...
            "sourcepage": "c.txt",
            "sourcefile": "c.txt",
            "storageUrl": f"https://test.blob.{cloudConfig['storageEndpointSuffix']}/c.txt",
        },
    ]
