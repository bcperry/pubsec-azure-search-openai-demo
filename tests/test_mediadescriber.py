...
async def test_contentunderstanding_analyze(monkeypatch, caplog):
    ...
    def mock_post(*args, **kwargs):
        if kwargs.get("url").find("badanalyzer") > 0:
            return MockResponse(
                status=200,
                headers={
                    "Operation-Location": "https://testcontentunderstanding.{cloudConfig['cognitiveServicesEndpointSuffix']}/contentunderstanding/analyzers/badanalyzer/operations/7f313e00-4da1-4b19-a25e-53f121c24d10?api-version=2024-12-01-preview"
                },
            )
        if kwargs.get("url").endswith("contentunderstanding/analyzers/image_analyzer:analyze"):
            return MockResponse(
                status=200,
                headers={
                    "Operation-Location": "https://testcontentunderstanding.{cloudConfig['cognitiveServicesEndpointSuffix']}/contentunderstanding/analyzers/image_analyzer/results/53e4c016-d2c0-48a9-a9f4-38891f7d45f0?api-version=2024-12-01-preview"
                },
            )
        else:
    ...
    def mock_get(self, url, **kwargs):
        if url.endswith(
            ...
            "https://testcontentunderstanding.{cloudConfig['cognitiveServicesEndpointSuffix']}/contentunderstanding/analyzers/badanalyzer/operations/7f313e00-4da1-4b19-a25e-53f121c24d10?api-version=2024-12-01-preview"
        ):
            return MockResponse(status=200, text=json.dumps({"status": "Failed"}))
        elif url.endswith(
            "https://testcontentunderstanding.{cloudConfig['cognitiveServicesEndpointSuffix']}/contentunderstanding/analyzers/image_analyzer/operations/7f313e00-4da1-4b19-a25e-53f121c24d10?api-version=2024-12-01-preview"
        ):
    ...
    def mock_put(self, *args, **kwargs):
        ...
        if kwargs.get("url").find("wrongservicename") > 0:
            ...
            return MockResponse(
                status=201,
                headers={
                    "Operation-Location": "https://testcontentunderstanding.{cloudConfig['cognitiveServicesEndpointSuffix']}/contentunderstanding/analyzers/image_analyzer/operations/7f313e00-4da1-4b19-a25e-53f121c24d10?api-version=2024-12-01-preview"
                },
            )
        else:
    ...
    describer = ContentUnderstandingDescriber(
        endpoint="https://testcontentunderstanding.{cloudConfig['cognitiveServicesEndpointSuffix']}", credential=MockAzureCredential()
    )
    ...
    describer_wrong_endpoint = ContentUnderstandingDescriber(
        endpoint="https://wrongservicename.{cloudConfig['cognitiveServicesEndpointSuffix']}", credential=MockAzureCredential()
    )
    with pytest.raises(Exception):
        await describer_wrong_endpoint.create_analyzer()

    describer_existing_analyzer = ContentUnderstandingDescriber(
        endpoint="https://existinganalyzer.{cloudConfig['cognitiveServicesEndpointSuffix']}", credential=MockAzureCredential()
    )
    ...
    describer_bad_analyze = ContentUnderstandingDescriber(
        endpoint="https://badanalyzer.{cloudConfig['cognitiveServicesEndpointSuffix']}", credential=MockAzureCredential()
    )
    with pytest.raises(Exception):
